...
--> 한 줄 구성
INSERT INTO TBL_MEMBERLIST(MID, NAME, TELEPHONE) VALUES(MEMBERLISTSEQ.NEXTVAL, '민찬우', '010-1111-1111')
;
--==>> 1 행 이(가) 삽입되었습니다.

INSERT INTO TBL_MEMBERLIST(MID, NAME, TELEPHONE) VALUES(MEMBERLISTSEQ.NEXTVAL, '김태민', '010-2222-2222')
;
--==>> 1 행 이(가) 삽입되었습니다.
