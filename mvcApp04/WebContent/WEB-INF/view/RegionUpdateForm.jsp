		...
		<form action="regionupdate.action" method="post" id="regionForm">
			<div class="form-group">
				...
				<div class="input-group">
					<div class="input-group-addon">현재 있는 지역 목록</div>
				...
				<div class="input-group">
					<div class="input-group-addon">수정전 지역번호</div>
					<input type="text" id="regionId" name="regionId" class="form-control" readonly="readonly" value="${regionId }"/>
				</div>
				
				<div class="input-group">
					<div class="input-group-addon">수정전 지역명</div>
					<input type="text" id="regionNameBefore" name="regionNameBefore" class="form-control" readonly="readonly" value="${regionName }"/>
				</div>
				
				<div class="input-group">
					<div class="input-group-addon">수정후 지역명</div>
				...
				<div class="input-group">
					<div class="btn-group" role="group" style="width: 100%;">
						<button type="button" class="btn btn-primary btn-lg" id="submitBtn">지역 수정</button>
