/*==================================================================================================
	#09. MemberListDeleteController.java
	- 사용자 정의 컨트롤러 클래스
	- 학생 데이터 삭제 액션 처리 → 처리 후 memberlist.action 을 다시 요청할 수 있도록 안내
...
public class MemberListDeleteController implements Controller
{
