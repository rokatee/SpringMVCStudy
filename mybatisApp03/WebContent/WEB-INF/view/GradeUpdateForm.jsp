						...
						<tr>
							<td>
								<div class="input-group" role="group">
									...
									value="${grade.sid }" maxlength="30" readonly="readonly">
						...
						<tr>
							<td>
								<div class="input-group" role="group">
									...
									value="${grade.sub1 }" maxlength="30" required="required">
									<span class="input-group-addon"></span>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td>
								<div class="input-group" role="group">
									...
									value="${grade.sub2 }" maxlength="30" required="required">
									<span class="input-group-addon"></span>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td>
								<div class="input-group" role="group">
									...
									value="${grade.sub3 }" maxlength="30" required="required">
									<span class="input-group-addon"></span>
								</div>
							</td>
						</tr>
